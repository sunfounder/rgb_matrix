...
def snake_game():
    ...
    while True:
        if game_count < 50:   
            rr.draw_rectangle(rectangle_coor,fill=(0,51,51),outline=None, width=0)   #draw a rectangle
        else:
            rr.draw_rectangle(rectangle_coor,fill=(0,0,51),outline=None, width=0)   #draw a rectangle   
        if eat_flag == False:
